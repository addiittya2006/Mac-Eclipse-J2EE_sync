...
public class TransacMain {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException , FileNotFoundException, URISyntaxException{
		...
		try{
			...
			// FileInputStream fp = new FileInputStream("/Users/addiittya/Desktop/com/addiittya/jdbc_transac.properties");
			URL url = TransacMain.class.getClassLoader().getResource("com/addiittya/transac/jdbc_transac.properties");
